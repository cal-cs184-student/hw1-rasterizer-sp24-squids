...
> > [please note: the S feature for my HW was not producing .png screeshots in the working directory, therefore all following IMGs will unfortunately be screenshots... :( ]
